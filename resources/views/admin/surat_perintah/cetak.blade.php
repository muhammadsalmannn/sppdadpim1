...
<body>
    <div class="container container-fluid">
        <table align="center" class="kop">
            <tr>
                <td><img src="{{ asset('assets/images/logo-icon.png') }}" alt="Pemprov"
                ...
                <td align="center">
                    ...
                    <font size="2">Jl.Gajah Mada Nomor 2 Samarinda Kode Pos 75121 Kalimantan Timur</font><br>
                    <font size="2">Telepon : (0541) 733333 Fax. (0541) 737762 - 742111</font><br>
                    <font size="2">Website : https://kaltimprov.go.id</font><br>
                </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <div class="container container-fluid">
        <table class="table table-bordered h6">
            <tr>
                ...
                <td> Kepala Biro Administrasi Pimpinan</td>
            </tr>
            <tr>
                <th scope="row">2</th>
            ...
            <tr>
                ...
                <td>PEMERINTAH PROVINSI KALIMANTAN TIMUR SEKRETARIAT DAERAH </td>
            </tr>
        </table>
    </div>
    <div class="container">
    ...
    <div class="container container-fluid">
        <table>
            ...
            <tr>
                <td></td>
                <td class="kanant"></td>
                <td class="kanant" style="font-weight: bold;">Kepala Biro Administrasi Pimpinan </td>
            </tr>
        </table>
